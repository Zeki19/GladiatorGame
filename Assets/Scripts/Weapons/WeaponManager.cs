...
namespace Weapons
{
    public class WeaponManager : MonoBehaviour
    {
        ...
        [Header("Weapons list")] [SerializeField]
        private List<SoWeapon> weapons;

        private Dictionary<GameObject, Weapon> _droppedWeapons;

        [Header("SpawnPoints list")] [SerializeField]
        private List<Vector3> spawnPoints;

        [SerializeField] private List<Vector3> usedSpawnPoint;

        [Header("Respawn config")] [SerializeField]
        private Vector2 RespawnTimeRange;

        [SerializeField] private Vector2Int RespawnWeaponQuantity;
        [SerializeField] private int MinimumAmountOfWeaponsInTheGround;
        ...
        public void DestroyWeapon(Weapon weapon)
        {
            ...
            if (_droppedWeapons.Count == MinimumAmountOfWeaponsInTheGround)
